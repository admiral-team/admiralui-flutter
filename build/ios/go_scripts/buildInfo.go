...
func (buildInfo BuildInfo) build_failed_info(pullNumber string) string {
	...
	resultString += "<strong>Build Url: </strong>" + "https://github.com/admiral-team/admiralui-flutter/pull/" + pullNumber + "/checks" + "\n"
	return resultString
}
...
func (buildInfo BuildInfo) telegram_release_message() string {
	...
	resultString += "Platform: Flutter" + "\n"
	resultString += "Link: https://github.com/admiral-team/admiralui-flutter/releases/tag/" + buildInfo.External_version + "\n"
	return resultString
}
