...
class CircularCountDownTimer extends StatefulWidget {
  ...
  /// Handles Countdown Timer (true for Reverse Countdown (max to 0),
  /// false for Forward Countdown (0 to max)).
  final bool isReverse;

  /// Handles Animation Direction (true for Reverse Animation,
   ...
   * It also provides the default function in case you want 
   * to format specific moments
     as in reverse when reaching '0' show 'GO', and for the rest of 
     the instances follow 
     the default behavior.
  */
  final Function(
    Function(Duration duration) defaultFormatterFunction,
    Duration duration,
...
class CircularCountDownTimerState extends State<CircularCountDownTimer>
  ...
  String get time {
    ...
    if (widget.onChange != null) widget.onChange?.call(timeStamp);
  ...
  void _onStart() {
    if (widget.onStart != null) widget.onStart?.call();
  }

  void _onComplete() {
    if (widget.onComplete != null) widget.onComplete?.call();
  }
    ...
    _controller!.addStatusListener((AnimationStatus status) {
      switch (status) {
        ...
        case AnimationStatus.completed:
          ...
          /// [AnimationStatus.completed] is
          /// invoked here this animation is [isReverse]
          /// Only call the [_onComplete]
          /// block when the animation is not reversed.
...
class CountDownController {
  ...
  /// Here optional int parameter **duration**
  /// is the updated duration for countdown timer
  ...
  /// Time Used in terms of **Forward Countdown** and Time Left in terms
  ///  of **Reverse Countdown**
  String? getTime() {
    if (_state != null && _state?._controller != null) {
