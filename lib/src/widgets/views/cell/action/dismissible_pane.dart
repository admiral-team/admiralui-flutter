...
import 'package:admiralui_flutter/src/widgets/views/cell/action/dismissible_pane_motions.dart';
...
class _DismissiblePaneState extends State<DismissiblePane> {
  ...
  void initState() {
    ...
    assert(() {
      ...
      = context.findAncestorWidgetOfExactType<Slidable>()!;
  ...
  Future<void> handleDismissGestureChanged() async {
    final EndGesture? endGesture = controller!.dismissGesture.value!.endGesture;
