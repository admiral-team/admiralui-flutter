...
class SlidableNotification {
  ...
  void dispatch(BuildContext context, SlidableController controller) {
    final _SlidableNotificationListenerScope? scope = context
...
class _SlidableNotificationListenerState
  ...
  void handleNotification(
    ...
    if (widget.autoClose && !controller.closing) {
      ...
      final SlidableController? lastOpenController = 
      openControllers[notification.tag];
  ...
  void clearController(SlidableController controller, Object? tag) {
    final SlidableController? lastOpenController = openControllers[tag];
...
class _SlidableNotificationSenderState
  ...
  void didChangeDependencies() {
    ...
    final _SlidableNotificationListenerState? state = context
  ...
  void handleRatioChanged() {
    final SlidableController controller = widget.controller;
    final SlidableRatioNotification notification = SlidableRatioNotification(
      tag: widget.tag,
