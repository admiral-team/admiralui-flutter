import 'package:admiralui_flutter/src/widgets/views/cell/action/action_pane_configuration.dart';
import 'package:admiralui_flutter/src/widgets/views/cell/action/auto_close_behavior.dart';
import 'package:admiralui_flutter/src/widgets/views/cell/action/controller.dart';
import 'package:admiralui_flutter/src/widgets/views/cell/action/dismissal.dart';
import 'package:admiralui_flutter/src/widgets/views/cell/action/gesture_detector.dart';
import 'package:admiralui_flutter/src/widgets/views/cell/action/notifications_old.dart';
import 'package:admiralui_flutter/src/widgets/views/cell/action/scrolling_behavior.dart';
...
class Slidable extends StatefulWidget {
  ...
  /// [DragStartBehavior.down] it
  ///  will begin when a down event is first detected.
  ///
  ...
  static SlidableController? of(BuildContext context) {
    final _SlidableControllerScope? scope = context
...
class _SlidableState extends State<Slidable>
  ...
  Alignment get actionPaneAlignment {
    final double sign = controller.direction.value.toDouble();
