...
const Duration _defaultMovementDuration = Duration(milliseconds: 200);
const Cubic _defaultCurve = Curves.ease;
...
class SlidableController {
  ...
  void _onDirectionChanged() {
    final int mulitiplier = isLeftToRight ? 1 : -1;
    final int index = (direction.value * mulitiplier) + 1;
