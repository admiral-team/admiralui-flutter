...
class SlidableGestureDetector extends StatefulWidget {
  ...
  /// [DragStartBehavior.down] it will 
  ...
  /// See also:
  ///
  ///  * [DragGestureRecognizer.dragStartBehavior], which 
  /// gives an example for the different behaviors.
...
class _SlidableGestureDetectorState extends State<SlidableGestureDetector> {
  ...
  Widget build(BuildContext context) {
    final bool canDragHorizontally = directionIsXAxis && widget.enabled;
    final bool canDragVertically = !directionIsXAxis && widget.enabled;
  ...
  void handleDragEnd(DragEndDetails details) {
    final Offset delta = lastPosition - startPosition;
    final double primaryDelta = directionIsXAxis ? delta.dx : delta.dy;
