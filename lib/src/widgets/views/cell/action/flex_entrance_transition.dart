...
class _RenderFlexEntranceTransition extends RenderBox
  ...
  void updateChildOffsets(RenderObject child) {
    ...
    if (parentData is _FlexEntranceTransitionParentData) {
      final double mainAxisPosition = parentData.mainAxisPosition?.evaluate(
            _mainAxisPosition,
          ) ??
          0;
      switch (_direction) {
  ...
  @override
  void performLayout() {
    final int totalFlex = getTotalFlex();
    ...
    visitChildren((RenderObject child) {
      ...
      parentData.mainAxisPosition = Tween<double>(
        begin: begin,
  ...
  bool hitTestChildren(BoxHitTestResult result, {required Offset position}) {
    ...
    while (child != null) {
      final _FlexEntranceTransitionParentData? childParentData =
          child.parentData as _FlexEntranceTransitionParentData?;
